...
Haskell implementation of BOLT #3 (Lightning Network transactions).

Specification: https://github.com/lightning/bolts/blob/master/03-transactions.md

## Project Structure

- `lib/` - library source (Lightning.Protocol.BOLT3)
